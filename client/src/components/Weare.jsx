            ...
            <div className="w-full">
              <div className="flex m-4">
                ...
                <div className="ml-4 text-start">
                  ...
                  <div className="text-gray-400">
                    Learn from Industry expert Instructors through courses in
                    Web Development, UI/UX Design, Data Science, Artificial
              ...
              <div className="flex m-4">
                ...
                <div className="ml-4 text-start">
                  ...
                  <div className="text-gray-400">
                    Our courses are designed to provide comprehensive learning
                    paths that help you achieve your career goals.
                  </div>
                </div>
              </div>
              <hr className="mb-4" />
