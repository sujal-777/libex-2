  ...
  return (
    <div className="flex flex-col-reverse md:flex-row justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center p-4 md:p-12">
        <form onSubmit={createAccount} className="w-full max-w-sm mx-auto">
          <h2 className="text-3xl font-semibold text-gray-800 mb-4 text-center">Sign Up</h2>
          <p className="text-gray-600 mb-6 text-center">Create an account to explore all our features.</p>
