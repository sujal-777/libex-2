  ...
  return (
    <div>
      <div className="relative bg-gray-300 h-80 flex justify-center items-center flex-col">
        ...
        {/* Right Image */}
        <img
          src="/Images/Overlay-About.png" // Replace with your right-side image URL
          alt="Right Prop"
        ...
        {/* Decorative Lines */}
        <img
          src="/Images/line-About-1.png" // Replace with your left-line image URL
          alt="Left Line"
          className="absolute left-10 top-1/3 transform -translate-y-1/2"
        />
        <img
          src="/Images/line-About-2.png" // Replace with your right-line image URL
          alt="Right Line"
      ...
      <div className="flex justify-center mt-32">
        <div className="flex flex-col justify-center w-2/3">
          <div className="flex">
            ...
            <div>
            <img src="/Images/Group-Image-2-About.png" alt="Group-Image" className="absolute right-1/4 h-2/3 w-96 " />
            </div>
            </div>
          </div>
                ...
                <div className="flex flex-col justify-center w-full md:w-5/6  p-5">
                  ...
                  <div className="text-gray-400">
                    ...
                    <div className="absolute">
                      <img
                        src="/Images/Mask-Group-2.png" // Replace with your left-side image URL
                        alt="Left Prop"
                        className="absolute left-0 top-1/2 transform -translate-y-1/2 h-80 w-70 z-10"
                      />
                      <img
                        src="/Images/Overlay+Blur-Purple.png" // Replace with your right-side image URL
                        alt="Right Prop"
